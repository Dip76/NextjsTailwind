...
const SideBar = ({ showSideBar }: Props) => {
  return (
    <aside
      id="default-sidebar"
      className={`fixed  w-64 h-screen ${showSideBar ? "" : "hidden"} `}
      aria-label="Sidebar"
    >
        ...
        <ul className="space-y-2 font-medium">
          <li>
            ...
            >
              ...
              <span className="ms-3">Discussion Forum</span>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Sentiment</span>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Sector</span>
            </a>
          </li>
          <li>
            <a
